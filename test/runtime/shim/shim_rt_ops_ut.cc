...
public:
    void SetUp() override
    {
        ...
        MockShimV2_SetMock(&m_shimv2);
        ::testing::Mock::AllowLeak(&m_shimv2);
    }
...
TEST_F(ShimRtOpsUnitTest, test_rt_shim_start)
{
...
TEST_F(ShimRtOpsUnitTest, test_rt_shim_clean_resource)
{
...
TEST_F(ShimRtOpsUnitTest, test_rt_shim_rm)
{
...
TEST_F(ShimRtOpsUnitTest, test_rt_shim_exec)
{
...
TEST_F(ShimRtOpsUnitTest, test_rt_shim_status)
{
