...
static int mk_sub_directors(const char *id, const char *parent, const char *layer_dir, const char *driver_home)
{
    int ret = 0;
    char *lowers = NULL;
                     ...
                     const struct driver_create_opts *create_opts)
{
    ...
    if (mk_sub_directors(id, parent, layer_dir, driver->home) != 0) {
        ret = -1;
        goto err_out;
    }
