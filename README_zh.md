...
embedded image镜像格式是一种嵌入式的镜像格式，占用资源低，主要用于嵌入式应用场景。
...
**如果您想要使用rpm包安装`iSulad`**，请查看rpm安装指南 [rpmbuild_guide](./docs/build_guide/rpmbuild_guide.md)

**如果您是一名开发者，想要从源代码构建iSulad**，请查看源码编译指南 [build_guide](./docs/build_guide/build_guide_zh.md)
...
`iSulad`v2.6.32 之后的版本支持在任何内核上运行。
