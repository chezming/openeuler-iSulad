...
if (ENABLE_CRI_API_V1 AND ENABLE_NRI)
set(NRI_PROTOS_OUT_PATH ${GRPC_OUT_PRE_PATH}/src/api/services/nri)
endif()
...
if (ENABLE_CRI_API_V1 AND ENABLE_NRI)
    execute_process(COMMAND mkdir -p ${NRI_PROTOS_OUT_PATH})
    PROTOC_CPP_GEN(nri ${NRI_PROTOS_OUT_PATH} ${PROTOS_PATH}/nri/nri.proto)
    PROTOC_GRPC_GEN(nri ${NRI_PROTOS_OUT_PATH} ${PROTOS_PATH}/nri/nri.proto)
endif()
