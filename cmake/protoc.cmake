...
if (GRPC_CONNECTOR)
    ...
    execute_process(COMMAND ${CMD_PROTOC} -I ${PROTOS_PATH}/volumes -I ${TYPES_PROTOS_PATH}
	--cpp_out=${VOLUME_PROTOS_OUT_PATH} ${PROTOS_PATH}/volumes/volumes.proto ERROR_VARIABLE volumes_err)
    if (volumes_err)
        message("Parse volumes.proto failed: ")
        message(FATAL_ERROR ${volumes_err})
    endif()

    execute_process(COMMAND ${CMD_PROTOC} -I ${PROTOS_PATH}/volumes -I ${TYPES_PROTOS_PATH} --grpc_out=${VOLUME_PROTOS_OUT_PATH}
        --plugin=protoc-gen-grpc=${CMD_GRPC_CPP_PLUGIN} ${PROTOS_PATH}/volumes/volumes.proto ERROR_VARIABLE volumes_err)
    if (volumes_err)
